          ...
          <>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8">
              ...
              <MetricsCard
                ...
                icon={Server}
                trend={
                  metrics && metrics.activeProviders === metrics.totalProviders
                    ? 'up'
                    : 'down'
                }
              />
            ...
            <div className="grid gap-4 md:grid-cols-3 mb-8">
              <Card>
                <CardHeader>
                  <CardTitle className="text-sm font-mac-medium">
                    Requests Today
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-2xl font-mac-bold">
            ...
            <Card className="mb-8">
              <CardHeader>
                ...
                <CardDescription>
                  Health and performance metrics by provider
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    >
                      ...
                      <div className="flex gap-6 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-mac-medium text-red-600">
                            {provider.errorCount}
                          </p>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <p className="font-mac-medium text-green-600">
